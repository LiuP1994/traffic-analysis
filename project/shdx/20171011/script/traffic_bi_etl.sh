...
loadstamp=""
if [[ ${q} -eq 1 ]]; then
	loadstamp="loadstamp between '00' and '01'"
fi
if [[ ${q} -eq 2 ]]; then
	loadstamp="loadstamp between '02' and '03'"
fi
if [[ ${q} -eq 3 ]]; then
	loadstamp="loadstamp between '04' and '05'"
fi
if [[ ${q} -eq 4 ]]; then
	loadstamp="loadstamp between '06' and '07'"
fi
if [[ ${q} -eq 5 ]]; then
	loadstamp="loadstamp between '08' and '09'"
fi
if [[ ${q} -eq 6 ]]; then
	loadstamp="loadstamp between '10' and '11'"
fi
if [[ ${q} -eq 7 ]]; then
	loadstamp="loadstamp between '12' and '13'"
fi
if [[ ${q} -eq 8 ]]; then
	loadstamp="loadstamp between '14' and '15'"
fi
if [[ ${q} -eq 9 ]]; then
	loadstamp="loadstamp between '16' and '17'"
fi
if [[ ${q} -eq 10 ]]; then
	loadstamp="loadstamp between '18' and '19'"
fi
if [[ ${q} -eq 11 ]]; then
	loadstamp="loadstamp between '20' and '21'"
fi
if [[ ${q} -eq 12 ]]; then
	loadstamp="loadstamp between '22' and '23'"
fi
...
where datelabel='${filedate}' and (${loadstamp})
) t2;
exit;
EOF
`"
