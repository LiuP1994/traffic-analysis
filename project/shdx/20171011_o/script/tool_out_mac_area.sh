...
select t3.mac,t3.pppoe,tid,phone,terminal_name,firstdate,lastdate,
dates,corp,area,province from (
select t1.username as mac,t2.pppoe as pppoe,tid,phone,terminal_name,firstdate,lastdate,
dates,corp,area
...
on t3.mac = t4.mac
group by t3.mac,t3.pppoe,tid,phone,terminal_name,firstdate,lastdate,
